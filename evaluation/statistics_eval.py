...
def easy_and_hard_cases():
    synthetic = ["cmapss", "azure", "ai4i"]
    experimental = ["ims", "femto","xjtu"]
    real = ["navarchos", "edp", "metro","bhd"]
    type_colors=['#0072B2', '#E69F00', '#009E73']
    label=["synthetic","experimental","real"]
    names=["cmapss","femto","ims","edp","metro","navarchos","azure","bhd","xjtu","ai4i"]
    ratio=[(13*709)/265256,(6*52)/21493,99*3/9464,(8640*8)/209236,(4*17280)/1516948,(21*1500)/854178,761*96/876100,4334*10/6626869,15*18/9216,166*4/10000]
    totext=[]
    allscores = []
    allnames = []
    colors=[]
